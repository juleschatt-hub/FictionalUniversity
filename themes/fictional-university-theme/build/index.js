...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.searchField).on("keyup", this.typingLogic.bind(this));
  }
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.overlayStatus && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
      this.openOverlay();
    }
